...
public sealed class DocumentSegment
{
        ...
        IReadOnlyDictionary<string, string>? additionalMetadata = null)
    {
        ...
        AdditionalMetadata = additionalMetadata is null
            ? EmptyMetadata
            : new ReadOnlyDictionary<string, string>(SanitizeMetadata(additionalMetadata));
    }
    ...
    private static IDictionary<string, string> SanitizeMetadata(IReadOnlyDictionary<string, string> metadata)
    {
