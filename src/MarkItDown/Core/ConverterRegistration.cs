...
/// </summary>
public sealed record ConverterRegistration(DocumentConverterBase Converter, double Priority)
{
    /// <summary>
    /// Gets the converter instance.
    /// </summary>
    public DocumentConverterBase Converter { get; } = Converter ?? throw new ArgumentNullException(nameof(Converter));
